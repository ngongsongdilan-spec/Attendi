...
const StudentDashboard = ({ user }) => {
  ...
  const studentName = user?.first_name ? `${user.first_name} ${user.last_name || ''}`.trim() : 'Student';
  ...
  }, [studentMatricule, currentSemester, currentSchoolYear, user, getCoursesForStudent, getCurrentSemesterStats]);
      ...
      <div className="bg-gradient-to-r from-[#1E1B4B] to-[#2A1F6E] rounded-xl md:rounded-2xl p-4 md:p-6 text-white">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          <div>
            ...
            <p className="text-[#8683BA] text-sm mt-1">Here is what is happening with your projects today.</p>
