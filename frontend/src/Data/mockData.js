 ...
 *
 * This file contains seed/reference data for development.
 * All data should come from the Django backend API in production.
 */
...
export const mockStudents = [
  {
    id: 1, matricule: 'FE24A389', fullName: 'Alex Scholar', email: 'alex.scholar@fet.edu',
    faculty: 'Engineering', department: 'Computer Engineering', level: '400',
    admissionYear: '2024/2025', enrolledCourses: ['CEF444', 'CEF450', 'CEF462', 'CEF476'],
  },
  {
    id: 2, matricule: 'FE24B456', fullName: 'Emma Watson', email: 'emma.watson@fet.edu',
    faculty: 'Engineering', department: 'Software Engineering', level: '400',
    admissionYear: '2024/2025', enrolledCourses: ['SE401', 'SE402', 'SE403', 'SE404'],
  },
  {
    id: 3, matricule: 'FE23C789', fullName: 'James Miller', email: 'james.miller@fet.edu',
    faculty: 'Engineering', department: 'Mechanical Engineering', level: '300',
    admissionYear: '2023/2024', enrolledCourses: ['ME301', 'ME302', 'ME303'],
  },
  {
    id: 4, matricule: 'FE25D012', fullName: 'Sarah Connor', email: 'sarah.connor@fet.edu',
    faculty: 'Engineering', department: 'Civil Engineering', level: '200',
    admissionYear: '2025/2026', enrolledCourses: ['CIV201', 'CIV202', 'CIV203'],
  },
  {
    id: 5, matricule: 'FE24E345', fullName: 'Michael Chang', email: 'michael.chang@fet.edu',
    faculty: 'Engineering', department: 'Electrical Engineering', level: '400',
    admissionYear: '2024/2025', enrolledCourses: ['EEF460', 'EEF462', 'EEF464'],
  },
];
...
export const mockAnnouncements = [
  { id: 1, title: 'Project Submission Deadline Extended', content: 'The deadline for the Smart Irrigation System project has been extended to December 15th, 2024.', date: '2024-10-20', author: 'Dr. Sarah Chen', type: 'Important', target: 'All Students' },
  { id: 2, title: 'Guest Lecture Tomorrow', content: 'Prof. Alan Turing will be giving a guest lecture on "AI Ethics" at 10:00 AM in Hall A.', date: '2024-10-22', author: 'Faculty Office', type: 'Event', target: 'Computer Engineering' },
  { id: 3, title: 'New Course Materials Available', content: 'Updated slides for Data Structures (CS301) are now available.', date: '2024-10-18', author: 'Dr. Alida Vance', type: 'Update', target: 'CS301' },
];

// ===== PROJECTS =====
export const mockProjects = [
  { id: 1, title: 'Smart Irrigation System', department: 'Software Engineering', supervisor: 'Dr. Sarah Chen', description: 'IoT-based automated irrigation system', status: 'Active', progress: 65, deadline: '2024-12-15', groupId: 1 },
  { id: 2, title: 'AI-Powered Analytics Platform', department: 'Computer Engineering', supervisor: 'Dr. Alida Vance', description: 'Machine learning platform for student analytics', status: 'Active', progress: 42, deadline: '2025-01-30', groupId: 2 },
];
...
// ===== HELPER FUNCTIONS =====
export const getCurrentSchoolYear = () => mockSchoolYears.find(y => y.isActive === true) || mockSchoolYears[0];
export const getCurrentSemester = () => mockSemesters.find(s => s.isCurrent === true) || mockSemesters[0];
